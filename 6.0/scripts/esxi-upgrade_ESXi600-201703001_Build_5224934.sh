...
if [[ -e "/vmfs/volumes/datastore1/ESXi600-201703001.zip" ]]; then
    esxcli software profile update \
        -d /vmfs/volumes/datastore1/ESXi600-201703001.zip \
        -p ESXi-6.0.0-20170304001-standard
    rm -f /vmfs/volumes/datastore1/ESXi600-201703001.zip
    reboot
fi
